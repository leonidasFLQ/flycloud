package com.flycloud.fly.common.core.util;
...
public class WebUtils extends org.springframework.web.util.WebUtils {
	...
	private static String[] splitClient(String header) throws UnsupportedEncodingException {
		if (header == null || !header.startsWith(BASIC_)) {
			throw new BaseException(CommonResponseEnum.REQUEST_HEADER_CLIRNTID_IS_NULL_ERROR.getCode(),CommonResponseEnum.REQUEST_HEADER_CLIRNTID_IS_NULL_ERROR.getMsg());
		}
		...
		try {
			...
			throw new BaseException(CommonResponseEnum.DECODE_AUTH_TOKEN_ERROR.getCode(),CommonResponseEnum.DECODE_AUTH_TOKEN_ERROR.getMsg());
		}
		...
		if (delim == -1) {
			throw new BaseException(CommonResponseEnum.AUTH_TOKEN_ERROR.getCode(),CommonResponseEnum.AUTH_TOKEN_ERROR.getMsg());
		}
