...
import com.flycloud.fly.admin.api.feign.RemoteUserService;
...
public class FlyUserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) {
		...
		if (cache != null && cache.get(username) != null) {
			return (FlyUser) cache.get(username).get();
		}
	...
	private UserDetails getUserDetails(R<UserInfo> result) {
		...
		// 构造security用户
		return new FlyUser(user.getUserId(), user.getDeptId(), user.getUsername(),
