 ...
 */
@Slf4j
public class FlyFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
	 ...
	 */
	public FlyFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext, OAuth2ProtectedResourceDetails resource,
